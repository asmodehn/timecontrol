...
from hypothesis.strategies import data, timedeltas, datetimes, integers

from timecontrol.tests.strats.st_timeinterval import st_timep
from timecontrol.timeinterval import TimeInterval, timep


class TestTimeInterval(unittest.TestCase):

    def assert_all(self, t1: typing.Union[timep, TimeInterval], t2: typing.Union[timep, TimeInterval],
    ...
    def test_interval_before(self, dt1:timep, data):

        # generating other datetimes, preventing equality
        dt2 = data.draw(st_timep(min_value=dt1 +1))
        dt3 = data.draw(st_timep(min_value=dt2 + 1))
        dt4 = data.draw(st_timep(min_value=dt3 + 1))
    ...
    @given(dt1=infer, data=data())
    def test_interval_before_timep(self, dt1:timep, data):
    ...
    @given(dt1=infer, data=data())
    def test_interval_after(self, dt1:timep, data):
    ...
    @given(dt1=infer, data=data())
    def test_interval_meets(self, dt1: timep, data):
    ...
    @given(dt1=infer, data=data())
    def test_interval_overlaps(self, dt1: timep, data):
        # generating other datetimes, preventing equality
        dt2 = data.draw(st_timep(min_value=dt1 + 1))
        dt3 = data.draw(st_timep(min_value=dt2 + 1))
        dt4 = data.draw(st_timep(min_value=dt3 + 1))
    ...
    @given(dt1=infer, data=data())
    def test_interval_during(self, dt1: timep, data):
        # generating other datetimes, preventing equality
        dt2 = data.draw(st_timep(min_value=dt1 + 1))
        dt3 = data.draw(st_timep(min_value=dt2 + 1))
        dt4 = data.draw(st_timep(min_value=dt3 + 1))
    ...
    @given(dt1=infer, data=data())
    def test_interval_starts(self, dt1: timep, data):
        # generating other datetimes, preventing equality
        dt2 = data.draw(st_timep(min_value=dt1 + 1))
        dt3 = data.draw(st_timep(min_value=dt2 + 1))
    ...
    @given(dt1=infer, data=data())
    def test_interval_finishes(self, dt1: timep, data):
        # generating other datetimes, preventing equality
        dt2 = data.draw(st_timep(min_value=dt1 + 1))
        dt3 = data.draw(st_timep(min_value=dt2 + 1))
    ...
    @given(dt1=infer, data=data())
    def test_interval_equals(self, dt1: timep, data):
        # generating other datetimes, preventing equality
        dt2 = data.draw(st_timep(min_value=dt1 + 1))
